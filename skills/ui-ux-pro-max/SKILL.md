...
```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "<产品类型> <行业> <关键词>" --design-system [-p "项目名称"]
```
...
**示例：**
```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "<查询>" --design-system --persist -p "项目名称"
```
...
**带页面特定覆盖：**
```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "<查询>" --design-system --persist -p "项目名称" --page "dashboard"
```
...
```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "<关键词>" --domain <领域> [-n <最大结果数>]
```
...
```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "<关键词>" --stack react-native
```
...
```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"
```
...
```bash
# 获取现代工具产品的风格选项
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "minimalism dark mode" --domain style

# 获取搜索交互和加载的 UX 最佳实践
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "search loading animation" --domain ux
```

### 步骤 4: 技术栈指南

```bash
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack react-native
```
...
```bash
# ASCII 框（默认）- 最佳终端显示
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system

# Markdown - 最佳文档格式
python3 skills/brainstorming/skills/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system -f markdown
```
