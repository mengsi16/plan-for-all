...
- **[superpowers](https://github.com/obra/superpowers)** — 提供了强大的 brainstorming 和 writing-plans 技能体系，让需求探索和计划生成变得系统化
- **[planning-with-files](https://github.com/OthmanAdi/planning-with-files)** — 提出的 Manus 思想——将计划写入磁盘、用文件持久化记忆——是 Plan-For-All 核心思想的来源
- **[ui-ux-pro-max](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill)** — 提供了专业的前端设计智能系统，包含 50+ 设计风格、161 配色方案、UX 指南等，为 Plan-For-All 的 Phase 2 前端设计收敛提供强大支持
